...
def main():
    ...
    skills_required = ["Python", "Django", "SQL", "Excel",
                       "Project", "Leadership", "React", "REST", "Machine Learning"]
    df_with_skills = match_keywords(
        os.path.join(CURRENT_DIR, "cleaned_resumes.csv"), skills_required)
    ...
    train_classifier(
        ...
        os.path.join(CURRENT_DIR, "final_predictions.csv"))

    print("✅ Done! Results saved to final_predictions.csv")
