...
ai_response("Analyzing user input with AI logic...", status="info", confidence=confidence_score)
if age >= 21 and income >= 3000 and credit_score >= 650:
    ai_response ("Approved: You meet all AI prediction thresholds", status="success")
elif 600 <= credit_score < 650 or 3000 <= income <3500:
    ai_response ("Warning: You're borderline. Improve credit or income.", status="warn")
elif age < 21:
